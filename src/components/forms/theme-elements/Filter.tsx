...
function Filter({ selectedDate, endDate, setSelectedDate, setEndDate, selectedCategory, setSelectedCategory, filterType, setType }: any) {
  ...
  return (
    ...
    >
      ...
      <FormControl sx={{
        marginLeft: 2, flex: 1, minWidth: 120, marginRight: 2,
      }}>
        <Select
          size="small"
