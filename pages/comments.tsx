...
import { PageContainer, DashboardCard, CustomTable, FallbackSpinner, ControlledDatePicker } from "@src/components";
...
function Comments() {
  ...
  const rowsTitles = ["#", "Comment", "Confidence", "Label", "Date", "Replied", "Action"];
